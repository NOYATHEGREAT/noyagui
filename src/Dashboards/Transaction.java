...
public class Transaction extends javax.swing.JFrame {
    ...
    try (Connection con = db.getConnection()) {
        ...
        String query = "SELECT t.transaction_id, b.bill_name, t.amount, t.payment_method, " +
                       "t.billingperiod, t.transaction_date, t.status, u.username " +
                       "FROM tbl_transaction t " +
                       "JOIN bill_type b ON t.bill_id = b.bill_id " +
                       "JOIN tbl_users u ON t.user_id = u.u_id " +
        ...
        model.setColumnIdentifiers(new String[]{
            "Transaction ID", "Bill Name", "Amount", "Payment Method", "Billing Period", "Date", "Status", "User"
        });
        ...
        ex.printStackTrace();
        JOptionPane.showMessageDialog(null, "Error displaying all payments!", "Error", JOptionPane.ERROR_MESSAGE);
    }
}
